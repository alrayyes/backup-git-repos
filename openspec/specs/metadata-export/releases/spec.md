# `metadata-export/releases` specification

## Purpose

Defines how backup-git-repos exports a repository's releases, notes and
uploaded assets alike, as an opt-in metadata kind alongside the git
mirror.
